...
<nav class="navbar main-nav navbar-expand-lg px-2 px-sm-0 py-2 py-lg-0">
  <div class="container">
    <a class="navbar-brand" href="/"><img src="{{ asset('front/images/logo.jpeg') }}" width="90px" alt="logo"></a>
...
<footer>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-12 m-md-auto align-self-center">
            <div class="block">
              <a href="index.html"><img src="{{ asset('front/images/logo.jpeg') }}" width="150px" alt="footer-logo"></a>
              <!-- Social Site Icons -->
    ...
    <div class="text-center bg-dark py-4">
      <small class="text-secondary">Copyright &copy; <script>document.write(new Date().getFullYear())</script>. Designed &amp; Developed by <a href="/{{ url('/') }}">War Cities</a></small class="text-secondary">
    </div>

      <div class="text-center bg-dark py-1">
     <small> <p>Distributed By <a href="{{ url('/') }}">War Cities</a></p></small class="text-secondary">
    </div>
  </footer>
